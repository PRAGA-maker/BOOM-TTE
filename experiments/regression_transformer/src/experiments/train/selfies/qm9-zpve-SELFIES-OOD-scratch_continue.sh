...
EXPERIMENT_NAME="qm9-zpve-proponly-selfies-scratch-OOD_continue"
# Set log directory
...
bsub -J $EXPERIMENT_NAME -G $MYBANK -W $MYTIME -o $MY_LOG_DIR/$OUTPUT_DIRNAME/$EXPERIMENT_NAME-%J.out python ../../../main.py \
  --model ../../../../flask-experiments/qm9-zpve-proponly-selfies-scratch-OOD/logs/checkpoint-best-71000/ \
