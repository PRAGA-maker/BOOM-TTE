...
EXPERIMENT_NAME="10k-den-proponly-selfies-scratch-OOD"
# Set log directory
...
bsub -J $EXPERIMENT_NAME -G $MYBANK -W $MYTIME -o $MY_LOG_DIR/$OUTPUT_DIRNAME/$EXPERIMENT_NAME-%J.out python ../../../main.py \
  ...
  --tokenizer ../../../pretrained_models/qed_IBM_scratch/vocab.txt \
  --train-data ../../../OOD_data/10k_dft_density_OOD/10k_dft_density_OOD_train.txt \
  --eval-data ../../../OOD_data/10k_dft_density_OOD/10k_dft_density_OOD_train.txt \
