...
EXPERIMENT_NAME="qm9-mu-proponly-selfies-scratch-OOD_continue"
# Set log directory
...
bsub -J $EXPERIMENT_NAME -G $MYBANK -W $MYTIME -o $MY_LOG_DIR/$OUTPUT_DIRNAME/$EXPERIMENT_NAME-%J.out python ../../../main.py \
  --model ../../../../flask-experiments/qm9-mu-proponly-selfies-scratch-OOD/logs/checkpoint-best-7000/ \
  --tokenizer ../../../pretrained_models/qed_IBM_scratch/vocab_qm9_mu.txt \
