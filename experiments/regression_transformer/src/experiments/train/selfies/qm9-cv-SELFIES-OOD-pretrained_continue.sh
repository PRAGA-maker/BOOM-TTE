...
EXPERIMENT_NAME="qm9-cv-proponly-selfies-pretrained-OOD_continue"
# Set log directory
...
bsub -J $EXPERIMENT_NAME -G $MYBANK -W $MYTIME -o $MY_LOG_DIR/$OUTPUT_DIRNAME/$EXPERIMENT_NAME-%J.out python ../../../main.py \
  --model ../../../../flask-experiments/qm9-cv-proponly-selfies-pretrained-OOD/logs/checkpoint-best-69000/ \
  --tokenizer ../../../pretrained_models/qed_IBM_pretrained/vocab_qm9_cv.txt \
  --train-data ../../../OOD_data/qm9_cv_OOD/qm9_cv_OOD_train.txt \
  --eval-data ../../../OOD_data/qm9_cv_OOD/qm9_cv_OOD_train.txt \
