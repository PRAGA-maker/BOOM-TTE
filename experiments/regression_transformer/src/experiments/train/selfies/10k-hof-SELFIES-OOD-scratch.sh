...
EXPERIMENT_NAME="10k-hof-proponly-selfies-scratch-OOD"
# Set log directory
...
bsub -J $EXPERIMENT_NAME -G $MYBANK -W $MYTIME -o $MY_LOG_DIR/$OUTPUT_DIRNAME/$EXPERIMENT_NAME-%J.out python ../../../main.py \
  ...
  --train-data ../../../OOD_data/10k_dft_hof_OOD/10k_dft_hof_OOD_train.txt \
  --eval-data ../../../OOD_data/10k_dft_hof_OOD/10k_dft_hof_OOD_train.txt \
