...
EXPERIMENT_NAME="qm9-homo-proponly-selfies-pretrained-OOD_continue"
# Set log directory
...
bsub -J $EXPERIMENT_NAME -G $MYBANK -W $MYTIME -o $MY_LOG_DIR/$OUTPUT_DIRNAME/$EXPERIMENT_NAME-%J.out python ../../../main.py \
  --model ../../../../flask-experiments/qm9-homo-proponly-selfies-pretrained-OOD/logs/checkpoint-best-66000/ \
  --tokenizer ../../../pretrained_models/qed_IBM_pretrained/vocab_qm9_homo.txt \
  --train-data ../../../OOD_data/qm9_homo_OOD/qm9_homo_OOD_train.txt \
  --eval-data ../../../OOD_data/qm9_homo_OOD/qm9_homo_OOD_train.txt \
