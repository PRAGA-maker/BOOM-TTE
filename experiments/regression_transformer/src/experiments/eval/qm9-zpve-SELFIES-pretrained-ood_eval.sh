...
EXPERIMENT_NAME="qm9-zpve-proponly-OOD-SELFIES-ood-test-eval"
# Set log directory
...
python ../../main.py \
  --model ../../../flask-experiments/qm9-zpve-proponly-selfies-pretrained-OOD_continue/logs/checkpoint-best-65000/ \
  --tokenizer ../../../flask-experiments/qm9-zpve-proponly-selfies-pretrained-OOD_continue/logs/checkpoint-best-65000/vocab.txt \
