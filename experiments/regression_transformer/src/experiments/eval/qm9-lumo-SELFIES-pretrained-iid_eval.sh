...
EXPERIMENT_NAME="qm9-lumo-proponly-OOD-SELFIES-iid-test-eval"
# Set log directory
...
python ../../main.py \
  --model ../../../flask-experiments/qm9-lumo-proponly-selfies-pretrained-OOD_continue/logs/checkpoint-best-67000/ \
  --tokenizer ../../../flask-experiments/qm9-lumo-proponly-selfies-pretrained-OOD_continue/logs/checkpoint-best-67000/vocab.txt \
