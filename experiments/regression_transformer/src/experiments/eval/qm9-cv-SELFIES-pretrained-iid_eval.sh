...
EXPERIMENT_NAME="qm9-cv-proponly-OOD-SELFIES-iid-test-eval"
# Set log directory
...
python ../../main.py \
  --model ../../../flask-experiments/qm9-cv-proponly-selfies-pretrained-OOD_continue/logs/checkpoint-best-61000/ \
  --tokenizer ../../../flask-experiments/qm9-cv-proponly-selfies-pretrained-OOD_continue/logs/checkpoint-best-61000/vocab.txt \
  ...
  --eval-file ../../OOD_data/qm9_cv_OOD/qm9_cv_OOD_iid_test.txt
