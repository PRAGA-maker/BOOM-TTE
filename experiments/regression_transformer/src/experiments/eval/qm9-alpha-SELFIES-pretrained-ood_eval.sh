...
EXPERIMENT_NAME="qm9-alpha-proponly-OOD-SELFIES-ood-test-eval"
# Set log directory
...
python ../../main.py \
  --model ../../../flask-experiments/qm9-alpha-proponly-selfies-pretrained-OOD_continue/logs/checkpoint-best-68000/ \
  --tokenizer ../../../flask-experiments/qm9-alpha-proponly-selfies-pretrained-OOD_continue/logs/checkpoint-best-68000/vocab.txt \
