...
EXPERIMENT_NAME="hof-proponly-10k-OOD-SELFIES-ood-test-eval"
# Set log directory
...
# Eval
python ../../main.py \
  --model ../../../flask-experiments/10k-hof-proponly-selfies-pretrained-OOD_backup/logs/checkpoint-best-21000/ \
  ...
  --eval-file ../../OOD_data/10k_dft_hof_OOD/10k_dft_hof_OOD_ood_test.txt
