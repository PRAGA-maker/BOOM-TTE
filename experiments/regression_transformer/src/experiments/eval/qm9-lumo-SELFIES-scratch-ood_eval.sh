...
EXPERIMENT_NAME="qm9-lumo-proponly-OOD-SELFIES-scratch-ood-test-eval"
# Set log directory
...
python ../../main.py \
  --model ../../../flask-experiments/qm9-lumo-proponly-selfies-scratch-OOD_continue/logs/checkpoint-best-62000/ \
  --tokenizer ../../../flask-experiments/qm9-lumo-proponly-selfies-scratch-OOD_continue/logs/checkpoint-best-62000/vocab.txt \
  --train-config ../../configs/train/qm9_lumo_prop_only.json \
  --eval-only \
  --output-dir $MY_LOG_DIR \
  --eval-accumulation-steps 2 \
  --param-path ../../configs/eval/FLASK_qm9_lumo_eval.json \
  --eval-file ../../OOD_data/qm9_lumo_OOD/qm9_lumo_OOD_ood_test.txt
