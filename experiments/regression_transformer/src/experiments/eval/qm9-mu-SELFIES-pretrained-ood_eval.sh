...
EXPERIMENT_NAME="qm9-mu-proponly-OOD-SELFIES-ood-test-eval"
# Set log directory
...
python ../../main.py \
  --model ../../../flask-experiments/qm9-mu-proponly-selfies-pretrained-OOD_continue/logs/checkpoint-best-51000/ \
  --tokenizer ../../../flask-experiments/qm9-mu-proponly-selfies-pretrained-OOD_continue/logs/checkpoint-best-51000/vocab.txt \
  --train-config ../../configs/train/qm9_mu_prop_only.json \
  --eval-only \
  --output-dir $MY_LOG_DIR \
  --eval-accumulation-steps 2 \
  --param-path ../../configs/eval/FLASK_qm9_mu_eval.json \
  --eval-file ../../OOD_data/qm9_mu_OOD/qm9_mu_OOD_ood_test.txt
