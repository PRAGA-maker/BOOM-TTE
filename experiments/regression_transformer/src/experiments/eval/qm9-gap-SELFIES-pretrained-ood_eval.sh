...
EXPERIMENT_NAME="qm9-gap-proponly-OOD-SELFIES-ood-test-eval"
# Set log directory
...
python ../../main.py \
  --model ../../../flask-experiments/qm9-gap-proponly-selfies-pretrained-OOD_continue/logs/checkpoint-best-63000/ \
  --tokenizer ../../../flask-experiments/qm9-gap-proponly-selfies-pretrained-OOD_continue/logs/checkpoint-best-63000/vocab.txt \
  --train-config ../../configs/train/qm9_gap_prop_only.json \
  --eval-only \
  --output-dir $MY_LOG_DIR \
  --eval-accumulation-steps 2 \
  --param-path ../../configs/eval/FLASK_qm9_gap_eval.json \
  --eval-file ../../OOD_data/qm9_gap_OOD/qm9_gap_OOD_ood_test.txt
