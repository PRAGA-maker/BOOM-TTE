...
EXPERIMENT_NAME="den-proponly-10k-OOD-SELFIES-scratch-iid-test-eval"
# Set log directory
...
# Eval the ID examples
python ../../main.py \
  --model ../../../flask-experiments/10k-den-proponly-selfies-scratch-OOD/logs/checkpoint-best-78000/ \
  ...
  --eval-file ../../OOD_data/10k_dft_density_OOD/10k_dft_density_OOD_iid_test.txt
