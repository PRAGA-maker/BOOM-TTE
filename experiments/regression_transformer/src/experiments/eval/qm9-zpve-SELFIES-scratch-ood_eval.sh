...
EXPERIMENT_NAME="qm9-zpve-proponly-OOD-SELFIES-scratch-ood-test-eval"
# Set log directory
...
python ../../main.py \
  --model ../../../flask-experiments/qm9-zpve-proponly-selfies-scratch-OOD_continue/logs/checkpoint-best-69000/ \
  --tokenizer ../../../flask-experiments/qm9-zpve-proponly-selfies-scratch-OOD_continue/logs/checkpoint-best-69000/vocab.txt \
  --train-config ../../configs/train/qm9_zpve_prop_only.json \
  --eval-only \
  --output-dir $MY_LOG_DIR \
  --eval-accumulation-steps 2 \
  --param-path ../../configs/eval/FLASK_qm9_zpve_eval.json \
  --eval-file ../../OOD_data/qm9_zpve_OOD/qm9_zpve_OOD_ood_test.txt
